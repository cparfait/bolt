      ...
      <SubmitButton
        className={
          complet
            ...
            : "inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-500 disabled:opacity-50"
        }
        pendingLabel="Envoi…"
      >
